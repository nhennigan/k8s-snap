...
<!-- SPREAD
python3 docs/tools/docs_validator.py --check gatewayclass-exists --name ck-gateway
...
<!-- SPREAD
python3 docs/tools/docs_validator.py --check pod-ready --label run=my-nginx
python3 docs/tools/docs_validator.py --check service-exists --name my-nginx
python3 docs/tools/docs_validator.py --check service-exists --name cilium-gateway-my-gateway
...
<!-- SPREAD
python3 docs/tools/docs_validator.py --check k8s-get-contains --key load-balancer --expect 10.0.1.0/28
python3 docs/tools/docs_validator.py --check k8s-get-contains --key load-balancer --expect "l2-mode: true"
-->
