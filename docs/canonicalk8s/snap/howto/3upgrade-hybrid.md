...
Determine which version of each application is currently deployed:
...
## How to perform an in-place upgrade for a CAPI machine

You may also need to upgrade a Cluster API managed machine.
